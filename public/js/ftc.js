 ...
 *	specifically, all source data is combined into a single structure (per division):
 
 TODO: dump out the data at run time, and then paste in here to document it
 
	.data [		an array of division data - will only ever have one or two elements
		{
			sources: {
				matches: {
					url: <string>
					status: <string> - 'loaded', 'loading', 'error'
					modified: <timestamp>
				}
			},
			matches: {
				<match-num string> : {
					...
					winner: 'red' or 'blue', or undefined
				}
			},
			matchList: []	<- array of match numbers (order is as-loaded from files),
			teams: {
				<team num> : {
					teamNum: <int>
					name: <string>
					...
					state: <string>
					country: <string>
					rank: <int> or undefined
					qualityPts: <int> or undefined
					rankingPts: <int> or undefined
					highest: <int> or undefined
					matchesPlayed: <int> or undefined
				}
			}
